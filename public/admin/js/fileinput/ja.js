...
(function ($) {
    ...
    $.fn.fileinputLocales['ja'] = {
        ...
        msgSizeTooSmall: '1KB以上のmp3ファイルをアップロードしてください。',
        ...
        msgInvalidFileExtension: '拡張子はmp3でアップロードしてください。',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
